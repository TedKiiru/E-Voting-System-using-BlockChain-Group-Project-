...
This system also shows user the elections that they have participated in so far. On the other side of the application, the admin can view the list of candidates contesting, the list of voters, and the list of elections.
